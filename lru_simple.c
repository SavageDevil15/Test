...
//    int incomingStream[] = {1, 2, 3, 2, 1, 5, 2, 1, 6, 2, 5, 6, 3, 1, 3, 6, 1, 2, 4, 3};
    ...
    for(int i = 0;i < n; i++)
    {
        ...
        // * IF HIT THEN SIMPLY PRINT THE CURRENT FRAME STATUS
        if(checkHit(incomingStream[i], queue, occupied)){
            printFrame(queue, occupied);
        }
        
        // * IF EMPTY SPACES ARE LEFT THEN SIMPLY POPULATE
            ...
            // ? j = numbers in the frames, distance acts like a dictionary to map the distance
